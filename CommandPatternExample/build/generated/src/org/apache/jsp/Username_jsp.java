...
public final class Username_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("     var id = '';\n");
      out.write("        SC.get('/users/daneemalik/playlists/',{q:track} , function(tracks) {\n");
      out.write("        /*$(tracks).each(function(index, track) {  \n");
      out.write("         $('#second').append('<img src=\"images/soundcloud-icon.png\" width=\"50\" height=\"50\"/><p>'+ track.title+'');\n");
      out.write("         $('#second').append('<button onClick=\"fun(this)\" type=\"submit\" id=\"'+track.uri+'\">Play</button>');\n");
      ...
      out.write("                     $('.hello').empty();\n");
      out.write("                     val = document.getElementById(\"trck\").value;\n");
      out.write("                     track = val;\n");
      out.write("                     alert(track);\n");
      out.write("                       SC.get('/users/'+track+'/playlists/', function(tracks) {\n");
      out.write("                       $(tracks).each(function(index, track) {\n");
      out.write("                      $('#second').append('<img src=\"images/soundcloud-icon.png\" width=\"50\" height=\"50\"/><p>'+ track.title+'');\n");
      out.write("                        $('#second').append('<button onClick=\"fun(this)\" type=\"submit\" id=\"'+track.uri+'\">Play</button>');\n");
      out.write("                        $('#second').append('</p>');\n");
      ...
      out.write("                        <input type=\"text\" id=\"trck\"/>\n");
      out.write("                    </li>\n");
      out.write("                    <li class=\"last\"><button onclick=\"getTrack()\" type=\"submit\">Search</button></li>\n");
      out.write("\t\t</ul> \n");
      out.write("\t</div>\n");
      ...
      out.write("        </div>\n");
      out.write("        <div  id=\"second\" class=\"hello\">\n");
      out.write("            <h2>User Playlists:</h2>\n");
      out.write("        </div>\n");
      out.write("        </div>\n");
      out.write("    \n");
